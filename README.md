...
```
cd existing_repo
git remote add origin https://gitlab.com/prinssalex/wheeled_robot_project_474343.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/prinssalex/wheeled_robot_project_474343/-/settings/integrations)
